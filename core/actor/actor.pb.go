...
var fileDescriptor_a9cd4f49a7d6d1fa = []byte{
	...
	,
}
...
func (m *PID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NodeId) > 0 {
		...
		i = encodeVarintActor(dAtA, i, uint64(len(m.NodeId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
